...
gyrate-legacy) _gmx_gyrate_legacy_compl ;;
h2order) _gmx_h2order_compl ;;
hbond) _gmx_hbond_compl ;;
hbond-legacy) _gmx_hbond_legacy_compl ;;
...
sans-legacy) _gmx_sans_legacy_compl ;;
sasa) _gmx_sasa_compl ;;
saxs-legacy) _gmx_saxs_legacy_compl ;;
scattering) _gmx_scattering_compl ;;
