...
/* Define if CUDA Graphs support is available */
#define GMX_HAVE_GPU_GRAPH_SUPPORT 1
...
#define GMX_SYCL_HIPSYCL GMX_SYCL_ACPP
...
#define GMX_HIPSYCL_HAVE_HIP_TARGET GMX_ACPP_HAVE_HIP_TARGET

// Define if AdaptiveCpp has CUDA target(s)
#define GMX_ACPP_HAVE_CUDA_TARGET 0
#define GMX_HIPSYCL_HAVE_CUDA_TARGET GMX_ACPP_HAVE_CUDA_TARGET

// Define if AdaptiveCpp should have AMD RDNA support (32-wide execution)
#define GMX_ACPP_ENABLE_AMD_RDNA_SUPPORT 0
#define GMX_HIPSYCL_ENABLE_AMD_RDNA_SUPPORT GMX_ACPP_ENABLE_AMD_RDNA_SUPPORT
...
#define GMX_GPU_NB_CLUSTER_SIZE 8
...
#define GMX_DESCRIBE_BLAS "Internal"

// Describes the origin of LAPACK routines
#define GMX_DESCRIBE_LAPACK "Internal"
